...
# --- STATUS FLAGS ---
REGISTER_OK=false
DUPLICATE_FAIL_OK=false
LOGIN_OK=false
EMAIL_TAKEN_OK=false
EMAIL_FREE_OK=false
USER_TAKEN_OK=false
USER_FREE_OK=false
PROFILE_OK=false
...
echo "=== SUMMARY ==="
echo "Register: $(status_icon $REGISTER_OK)"
echo "Duplicate Register Rejected: $(status_icon $DUPLICATE_FAIL_OK)"
echo "Login: $(status_icon $LOGIN_OK)"
echo "Email Check: Taken=$(status_icon $EMAIL_TAKEN_OK), Free=$(status_icon $EMAIL_FREE_OK)"
echo "Username Check: Taken=$(status_icon $USER_TAKEN_OK), Free=$(status_icon $USER_FREE_OK)"
echo "Profile Access: Private=$(status_icon $PROFILE_OK), Public=$(status_icon $PUBLIC_PROFILE_OK)"
